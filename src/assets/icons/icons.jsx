export function NameIcon({ size = 20 }) {
    return (
...
export function BirthIcon({ size = 20 }) {
    return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#111" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
export function AddressIcon({ size = 20 }) {
    return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#111" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
...
export function GithubIcon({ size = 20 }) {
    return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="#111">
...
export function IntroduceIcon({ size = 20 }) {
    return (
        <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="#111" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
            <path d="M17 3a2.8 2.8 0 0 1 4 4L7 21l-5 1 1-5Z" />
        </svg>
    )
}